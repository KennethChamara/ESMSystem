...
public class UpdateproductsServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		// getServletContext().getRequestDispatcher("/WEB-INF/views/Listproducts.jsp");
		RequestDispatcher dispatcher = getServletContext().getRequestDispatcher("/Listproducts.jsp");
